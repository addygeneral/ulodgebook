                    ...
                    foreach ($map as $key => $value) {
                        ...
                        if (file_exists($menu)) {
                            @include($menu);
                                ...
                                $allmenu = ['dashboard','accounts','customer','expenditure','hrm','payment_setting','purchase','reports','room_facilities','room_reservation','room_setting','tax_management','units','addon','template'];
                            ?>
