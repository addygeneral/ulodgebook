<div class="card">
    ...
    <div class="card-header">
        <h4><?php echo display('expend_iture_list') ?><small class="float-right"><button type="button"
        class="btn btn-primary btn-md" data-target="#add0" data-toggle="modal"><i class="fa fa-plus-circle"
        aria-hidden="true"></i>
        <?php echo display('add_category_type')?></button></small></h4>
    </div>
    <?php endif; ?>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <strong><?php echo display('add_category_type');?></strong>
            ...
            <div class="col-sm-12">
                <div class="card-body">
                    ...
                    <table width="100%" id="exdatatable" class="datatable table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($categorilist)) {
                            ?>
                            <?php $sl = 1; ?>
                            <?php foreach ($categorilist as $type) { ?>
                            <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                ...
                                <td class="center">
                                    ...
                                    id="url_<?php echo html_escape($type->categorytypeid); ?>"
                                    value="<?php echo base_url("expend_iture/expend_iture/updateintfrm") ?>" />
                                    <a onclick="editinfo('<?php echo html_escape($type->categorytypeid); ?>')"
                                    ...
                                    <a href="<?php echo base_url("expend_iture/expend-iture-delete/".html_escape($type->categorytypeid)) ?>"
