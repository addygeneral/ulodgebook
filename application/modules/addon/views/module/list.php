            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php
                                ...
                                $def_mods = ['dashboard','accounts','customer','hrm','payment_setting','purchase','reports','expend_iture','room_facilities','room_reservation','room_setting','tax_management','units','addon','template'];
                                if (is_array($map))
