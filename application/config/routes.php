...
//Expenditure
$route['expend_iture/expend-iture-list'] = "expend_iture/expend_iture/index";
$route['expend_iture/expend-iture-delete/(:num)'] = "expend_iture/expend_iture/delete/$1";
$route['expend_iture/expen-ses-list'] = "expend_iture/expen_ses/index";
$route['expend_iture/expen-ses-delete/(:num)'] = "expend_iture/expen_ses/delete/$1";
$route['expend_iture/incom-es-list'] = "expend_iture/incom_es/index";
$route['expend_iture/incom-es-delete/(:num)'] = "expend_iture/incom_es/delete/$1";
$route['default_controller'] = 'DocumentController';
