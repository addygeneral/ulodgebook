...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 07, 2023 at 08:50 AM
...
--
-- Database: `php_xain_hotel_management`
--
...
CREATE TABLE IF NOT EXISTS `acc_bank` (
  ...
  `opening_credit` int DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`bank_id`)
...
CREATE TABLE IF NOT EXISTS `acc_income_expence` (
  ...
  `Perpose` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `add_ons` (
  ...
  `tax0` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `tax1` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `bedstype` (
  `Bedstypeid` int NOT NULL AUTO_INCREMENT,
  `bedstypetitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `booked_details` (
  `book_detailsid` int NOT NULL AUTO_INCREMENT,
  `bookedid` int NOT NULL,
  `booking_type` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `booking_source` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `booking_source_no` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `extracheckin` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `extracheckout` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `arival_from` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `purpose` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `extra_facility_days` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `extrabed` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `extraperson` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `extrachild` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `complementary` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `complementaryprice` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `discountreason` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `discountamount` decimal(10,0) DEFAULT NULL,
  `commissionpersent` int DEFAULT NULL,
  `commissionamount` decimal(10,0) DEFAULT NULL,
  `payment_method` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `advance_amount` decimal(10,2) DEFAULT NULL,
  `advance_remarks` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `remarks` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `booked_from` int DEFAULT '0' COMMENT '0=admin,1=user',
...
CREATE TABLE IF NOT EXISTS `booked_info` (
  ...
  `booking_number` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `date_time` datetime NOT NULL,
  `roomid` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `nuofpeople` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT '0',
  `children` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `total_room` int NOT NULL DEFAULT '0',
  `room_no` varchar(45) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `roomrate` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `promocode` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `total_price` decimal(10,2) NOT NULL DEFAULT '0.00',
  `paid_amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `offer_discount` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '0.00',
  `full_guest_name` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `special_request` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `coments` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `checkindate` datetime NOT NULL,
  `checkoutdate` datetime NOT NULL,
  `cutomerid` int NOT NULL,
  `bookingstatus` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL COMMENT '0=pending,1=cancel,2=success,3=finish,4=checkin,5=checkout',
...
CREATE TABLE IF NOT EXISTS `bookingtype` (
  ...
  `booktypetitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `customerinfo` (
  ...
  `customernumber` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `membership_type` int DEFAULT NULL COMMENT '1=bronze,2=silver,3=gold,4=platinum,5=vip',
  `firstname` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `lastname` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `fathername` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  ...
  `profession` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `isnationality` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `pid` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `pitype` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `imgfront` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `imgback` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `imgguest` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `contacttype` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `zipcode` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `nationality` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `passport` varchar(120) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `visano` varchar(80) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `purpose` varchar(80) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `profileimage` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  ...
  `dob` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `anniversary` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  ...
  `cust_phone` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `pass` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `balance` decimal(10,2) NOT NULL DEFAULT '0.00',
  `active` int DEFAULT NULL,
  `password_reset_token` text COLLATE latin1_general_ci,
...
(1, '0002', NULL, 'Mason', 'Elliott', NULL, 'wowidu@mailinator.com', 'Maxime eos laborum ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '96', 'd41d8cd98f00b204e9800998ecf8427e', '0.00', NULL, NULL, '2023-07-28');
...
CREATE TABLE IF NOT EXISTS `language` (
  ...
  `hindi` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2155 DEFAULT CHARSET=utf8mb3;
...
(36, 'file', 'Upload File', NULL, NULL, NULL, NULL, NULL, NULL),
...
(1846, 'transport_facility', 'Transport Facility', NULL, NULL, NULL, NULL, NULL, NULL),
(1847, 'flight_details_list', 'Flight Details List', NULL, NULL, NULL, NULL, NULL, NULL),
(1848, 'fl_details_add', 'Flight Details Add', NULL, NULL, NULL, NULL, NULL, NULL),
(1849, 'flight_num', 'Flight Number', NULL, NULL, NULL, NULL, NULL, NULL),
(1850, 'airlience_name', 'Airlience Name', NULL, NULL, NULL, NULL, NULL, NULL),
(1851, 'departure', 'Departure', NULL, NULL, NULL, NULL, NULL, NULL),
(1852, 'arrival', 'Arrival', NULL, NULL, NULL, NULL, NULL, NULL),
(1853, 'fly_from', 'Fly From', NULL, NULL, NULL, NULL, NULL, NULL),
(1854, 'fly_to', 'Fly To', NULL, NULL, NULL, NULL, NULL, NULL),
(1855, 'fl_details_update', 'Flight Details Update', NULL, NULL, NULL, NULL, NULL, NULL),
(1856, 'vehicle_details_list', 'Vehicle Details List', NULL, NULL, NULL, NULL, NULL, NULL),
(1857, 'vehicle_details_add', 'Vehicle Details Add', NULL, NULL, NULL, NULL, NULL, NULL),
(1858, 'vehicle_details_edit', 'Vehicle Details Update', NULL, NULL, NULL, NULL, NULL, NULL),
(1859, 'vehicle_number', 'Vehicle Number', NULL, NULL, NULL, NULL, NULL, NULL),
(1860, 'vehicle_type', 'Vehicle Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1861, 'fuel_type', 'Fuel Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1862, 'seat_capacity', 'Seat Capacity', NULL, NULL, NULL, NULL, NULL, NULL),
(1863, 'driver', 'Driver', NULL, NULL, NULL, NULL, NULL, NULL),
(1864, 'vehicle_booking_report', 'Vehicle Booking Report', NULL, NULL, NULL, NULL, NULL, NULL),
(1865, 'vehicle_booking_list', 'Vehicle Booking List', NULL, NULL, NULL, NULL, NULL, NULL),
(1866, 'vehicle_booking_add', 'Vehicle Booking Add', NULL, NULL, NULL, NULL, NULL, NULL),
(1867, 'vehicle_booking_edit', 'Vehicle Booking Update', NULL, NULL, NULL, NULL, NULL, NULL),
(1868, 'transportation_type', 'Transportation Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1869, 'assigned_driver', 'Assigned Driver', NULL, NULL, NULL, NULL, NULL, NULL),
(1870, 'pick_up', 'Pick Up', NULL, NULL, NULL, NULL, NULL, NULL),
(1871, 'drop_off', 'Drop Off', NULL, NULL, NULL, NULL, NULL, NULL),
(1872, 'transportation_time', 'Transportation Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1873, 'whatsapp', 'Whatsapp', NULL, NULL, NULL, NULL, NULL, NULL),
(1874, 'whatsapp_chat', 'Whatsapp Chat', NULL, NULL, NULL, NULL, NULL, NULL),
(1875, 'whatsapp_phone_numer_internation_standard', 'Whatsapp phone Numer International Standard', NULL, NULL, NULL, NULL, NULL, NULL),
(1876, 'whatsapp_phone_numer', 'Whatsapp Phone Numer', NULL, NULL, NULL, NULL, NULL, NULL),
(1877, 'whatsapp_setting', 'Whatsapp Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(1878, 'hello,_how_can_we_help_you?', 'Hello, How can we help you?', NULL, NULL, NULL, NULL, NULL, NULL),
(1879, 'ischatenable', 'Chat Enable', NULL, NULL, NULL, NULL, NULL, NULL),
(1880, 'wporder_enable', 'WhatsApp Booking Enable', NULL, NULL, NULL, NULL, NULL, NULL),
(1881, 'whatsorderplace', 'Do you want to Chat on WhatsApp??', NULL, NULL, NULL, NULL, NULL, NULL),
(1882, 'ordermanage', 'Restaurent', NULL, NULL, NULL, NULL, NULL, NULL),
(1883, 'manage_category', 'Manage Category', NULL, NULL, NULL, NULL, NULL, NULL),
(1884, 'category_list', 'Category List', NULL, NULL, NULL, NULL, NULL, NULL),
(1885, 'manage_food', 'Manage Food', NULL, NULL, NULL, NULL, NULL, NULL),
(1886, 'add_food', 'Add Food', NULL, NULL, NULL, NULL, NULL, NULL),
(1887, 'food_list', 'Food List', NULL, NULL, NULL, NULL, NULL, NULL),
(1888, 'food_varient', 'Food Variant', NULL, NULL, NULL, NULL, NULL, NULL),
(1889, 'food_availablity', 'Food Availability', NULL, NULL, NULL, NULL, NULL, NULL),
(1890, 'add_varient', 'Add Variant', NULL, NULL, NULL, NULL, NULL, NULL),
(1891, 'varient_name', 'Variant Name', NULL, NULL, NULL, NULL, NULL, NULL),
(1892, 'variant_list', 'Variant List', NULL, NULL, NULL, NULL, NULL, NULL),
(1893, 'variant_edit', 'Update Variant', NULL, NULL, NULL, NULL, NULL, NULL),
(1894, 'food_availablelist', 'Food Available List', NULL, NULL, NULL, NULL, NULL, NULL),
(1895, 'add_availablity', 'Add Available Day & Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1896, 'edit_availablity', 'Update Available Day & Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1897, 'available_day', 'Available Day', NULL, NULL, NULL, NULL, NULL, NULL),
(1898, 'available_time', 'Available Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1899, 'manage_addons', 'Manage Add-ons', NULL, NULL, NULL, NULL, NULL, NULL),
(1900, 'add_adons', 'Add Add-ons', NULL, NULL, NULL, NULL, NULL, NULL),
(1901, 'menu_addons', 'Add-ons Menu', NULL, NULL, NULL, NULL, NULL, NULL),
(1902, 'addons_list', 'Add-ons List', NULL, NULL, NULL, NULL, NULL, NULL),
(1903, 'assign_adons', 'Add-ons Assign', NULL, NULL, NULL, NULL, NULL, NULL),
(1904, 'assign_adons_list', 'Add-ons Assign List', NULL, NULL, NULL, NULL, NULL, NULL),
(1905, 'update_adons', 'Update Add-ons', NULL, NULL, NULL, NULL, NULL, NULL),
(1906, 'add_group_item', 'Add Group Item', NULL, NULL, NULL, NULL, NULL, NULL),
(1907, 'menu_type', 'Menu Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1908, 'parent_cat', 'Parent Category', NULL, NULL, NULL, NULL, NULL, NULL),
(1909, 'is_offer', 'Offer', NULL, NULL, NULL, NULL, NULL, NULL),
(1910, 'offerdate', 'Offer Start Date', NULL, NULL, NULL, NULL, NULL, NULL),
(1911, 'offerenddate', 'Select Kitchen', NULL, NULL, NULL, NULL, NULL, NULL),
(1912, 'select_kitchen', 'Update', NULL, NULL, NULL, NULL, NULL, NULL),
(1913, 'kitchen_name', 'Kitchen Name', NULL, NULL, NULL, NULL, NULL, NULL),
(1914, 'is_special', 'Special', NULL, NULL, NULL, NULL, NULL, NULL),
(1915, 'is_custome_quantity', 'Custom Quantity', NULL, NULL, NULL, NULL, NULL, NULL),
(1916, 'cookedtime', 'Cooking Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1917, 'item_name', 'Food Name', NULL, NULL, NULL, NULL, NULL, NULL),
(1918, 'component', 'Components', NULL, NULL, NULL, NULL, NULL, NULL),
(1919, 'vat_tax', 'Vat', NULL, NULL, NULL, NULL, NULL, NULL),
(1920, 'add_menu_type', 'Add Menu Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1921, 'menu_type_list', 'Menu Type List', NULL, NULL, NULL, NULL, NULL, NULL),
(1922, 'menu_type_name', 'Menu Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1923, 'icon', 'Icon', NULL, NULL, NULL, NULL, NULL, NULL),
(1924, 'menutype_edit', 'Menu Type Edit', NULL, NULL, NULL, NULL, NULL, NULL),
(1925, 'addons_name', 'Add-ons Name ', NULL, NULL, NULL, NULL, NULL, NULL),
(1926, 'pos_invoice', 'POS Invoice', NULL, NULL, NULL, NULL, NULL, NULL),
(1927, 'order_list', 'Order List', NULL, NULL, NULL, NULL, NULL, NULL),
(1928, 'pending_order', 'Pending Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1929, 'complete_order', 'Complete Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1930, 'cancel_order', 'Cancel Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1931, 'kitchen_dashboard', 'Kitchen Dashboard', NULL, NULL, NULL, NULL, NULL, NULL),
(1932, 'counter_dashboard', 'Counter Dashboard', NULL, NULL, NULL, NULL, NULL, NULL),
(1933, 'counter_list', 'Counter List', NULL, NULL, NULL, NULL, NULL, NULL),
(1934, 'pos_setting', 'POS Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(1935, 'sound_setting', 'Sound Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(1936, 'upload_notify', 'Upload Notification Sound', NULL, NULL, NULL, NULL, NULL, NULL),
(1937, 'placr_setting', 'Place order Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(1938, 'waiter', 'Waiter', NULL, NULL, NULL, NULL, NULL, NULL),
(1939, 'table', 'Table Map', NULL, NULL, NULL, NULL, NULL, NULL),
(1940, 'table_map', 'Table Map', NULL, NULL, NULL, NULL, NULL, NULL),
(1941, 'is_sound', 'Is Sound Enable', NULL, NULL, NULL, NULL, NULL, NULL),
(1942, 'quick_ord', 'Quick Order Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(1943, 'counter_no', 'Counter Number', NULL, NULL, NULL, NULL, NULL, NULL),
(1944, 'add_counter', 'Add Counter', NULL, NULL, NULL, NULL, NULL, NULL),
(1945, 'tabltno', 'Table No', NULL, NULL, NULL, NULL, NULL, NULL),
(1946, 'ord_num', 'Order Number', NULL, NULL, NULL, NULL, NULL, NULL),
(1947, 'ordtime', 'Order Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1948, 'remtime', 'Remaining Time', NULL, NULL, NULL, NULL, NULL, NULL),
(1949, 'ordtcoun', 'Order Time Countdown Board', NULL, NULL, NULL, NULL, NULL, NULL),
(1950, 'orderid', 'Order ID', NULL, NULL, NULL, NULL, NULL, NULL),
(1951, 'customer_type', 'Customer Type', NULL, NULL, NULL, NULL, NULL, NULL),
(1952, 'ordate', 'Order Date', NULL, NULL, NULL, NULL, NULL, NULL),
(1953, 'service_chrg', 'Service Charge', NULL, NULL, NULL, NULL, NULL, NULL),
(1954, 'customer_paid_amount', 'Customer Paid Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(1955, 'change_due', 'Change Due', NULL, NULL, NULL, NULL, NULL, NULL),
(1956, 'total_due', 'Total Due', NULL, NULL, NULL, NULL, NULL, NULL),
(1957, 'totalpayment', 'Total payment', NULL, NULL, NULL, NULL, NULL, NULL),
(1958, 'billing_to', 'Billing To', NULL, NULL, NULL, NULL, NULL, NULL),
(1959, 'bill_by', 'Bill By', NULL, NULL, NULL, NULL, NULL, NULL),
(1960, 'orderno', 'Order No.', NULL, NULL, NULL, NULL, NULL, NULL),
(1961, 'thanks_you', 'Thank you very much', NULL, NULL, NULL, NULL, NULL, NULL),
(1962, 'powerbybdtask', 'Powered  By: BDTASK, www.bdtask.com', NULL, NULL, NULL, NULL, NULL, NULL),
(1963, 'item', 'Item', NULL, NULL, NULL, NULL, NULL, NULL),
(1964, 'billing_from', 'Billing From', NULL, NULL, NULL, NULL, NULL, NULL),
(1965, 'order_status', 'Order Status', NULL, NULL, NULL, NULL, NULL, NULL),
(1966, 'billing_date', 'Billing Date', NULL, NULL, NULL, NULL, NULL, NULL),
(1967, 'cancel_reason', 'Cancel Reason', NULL, NULL, NULL, NULL, NULL, NULL),
(1968, 'customer_order', 'Customer Notes', NULL, NULL, NULL, NULL, NULL, NULL),
(1969, 'customerpicktime', 'Customer Pick-up Date and time', NULL, NULL, NULL, NULL, NULL, NULL),
(1970, 'size', 'Size', NULL, NULL, NULL, NULL, NULL, NULL),
(1971, 'qty', 'Quantity', NULL, NULL, NULL, NULL, NULL, NULL),
(1972, 'foodnote', 'Food Note', NULL, NULL, NULL, NULL, NULL, NULL),
(1973, 'addnotesi', 'Add Note', NULL, NULL, NULL, NULL, NULL, NULL),
(1974, 'sl_payment', 'Select Your Payment Method', NULL, NULL, NULL, NULL, NULL, NULL),
(1975, 'paymd', 'Payment Method', NULL, NULL, NULL, NULL, NULL, NULL),
(1976, 'crd_terminal', 'Card Terminal', NULL, NULL, NULL, NULL, NULL, NULL),
(1977, 'sl_bank', 'Select Bank', NULL, NULL, NULL, NULL, NULL, NULL),
(1978, 'lstdigit', 'Last 4 Digit', NULL, NULL, NULL, NULL, NULL, NULL),
(1979, 'cuspayment', 'Customer Payment', NULL, NULL, NULL, NULL, NULL, NULL),
(1980, 'cng_amount', 'Changes Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(1981, 'pay_print', 'Pay Now & Print Invoice', NULL, NULL, NULL, NULL, NULL, NULL),
(1982, 'payn', 'Pay Now', NULL, NULL, NULL, NULL, NULL, NULL),
(1983, 'ordid', 'Order ID', NULL, NULL, NULL, NULL, NULL, NULL),
(1984, 'can_reason', 'Cancel Reason', NULL, NULL, NULL, NULL, NULL, NULL),
(1985, 'can_ord', 'Cancel Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1986, 'add_customer', 'Add Customer', NULL, NULL, NULL, NULL, NULL, NULL),
(1987, 'fav_addesrr', 'Favorite Address', NULL, NULL, NULL, NULL, NULL, NULL),
(1988, 'nw_order', 'New Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1989, 'ongoingorder', 'On Going Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1990, 'tdayorder', 'Today Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1991, 'onlineord', 'Online Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1992, 'kitchen_status', 'Kitchen Status', NULL, NULL, NULL, NULL, NULL, NULL),
(1993, 'all', 'All', NULL, NULL, NULL, NULL, NULL, NULL),
(1994, 'del_company', 'Delivery Company', NULL, NULL, NULL, NULL, NULL, NULL),
(1995, 'thirdparty_orderid', 'Third-party Order ID', NULL, NULL, NULL, NULL, NULL, NULL),
(1996, 'vat_tax1', 'Vat/Tax', NULL, NULL, NULL, NULL, NULL, NULL),
(1997, 'quickorder', 'Quick Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1998, 'placeorder', 'Place Order', NULL, NULL, NULL, NULL, NULL, NULL),
(1999, 'update_group_item', 'pdate Group Item', NULL, NULL, NULL, NULL, NULL, NULL),
(2000, 'addons_qty', 'Add-ons Qty', NULL, NULL, NULL, NULL, NULL, NULL),
(2001, 'add_to_cart', 'Add To cart', NULL, NULL, NULL, NULL, NULL, NULL),
(2002, 'add_to_cart_more', 'Add Multiple Variant', NULL, NULL, NULL, NULL, NULL, NULL),
(2003, 'select_this_table', 'Select This Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2004, 'seat', 'Seat', NULL, NULL, NULL, NULL, NULL, NULL),
(2005, 'ord', 'Order', NULL, NULL, NULL, NULL, NULL, NULL),
(2006, 'seat_time', 'Time', NULL, NULL, NULL, NULL, NULL, NULL),
(2007, 'no_customer', 'No Customer', NULL, NULL, NULL, NULL, NULL, NULL),
(2008, 'mergeord', 'Merge Order', NULL, NULL, NULL, NULL, NULL, NULL),
(2009, 'before_time', 'Running Time', NULL, NULL, NULL, NULL, NULL, NULL),
(2010, 'cmplt', 'Complete', NULL, NULL, NULL, NULL, NULL, NULL),
(2011, 'split', 'Split', NULL, NULL, NULL, NULL, NULL, NULL),
(2012, 'no_order_run', 'No Order Running', NULL, NULL, NULL, NULL, NULL, NULL),
(2013, 'sl_product', 'Search Product', NULL, NULL, NULL, NULL, NULL, NULL),
(2014, 'ord_places', 'Order Placed Successfully', NULL, NULL, NULL, NULL, NULL, NULL),
(2015, 'do_print_in', 'Do you Want to Print Invoice???', NULL, NULL, NULL, NULL, NULL, NULL),
(2016, 'ord_complte', 'Order Completed', NULL, NULL, NULL, NULL, NULL, NULL),
(2017, 'ord_com_sucs', 'Order Completed Successfully', NULL, NULL, NULL, NULL, NULL, NULL),
(2018, 'token_no', 'Token NO', NULL, NULL, NULL, NULL, NULL, NULL),
(2019, 'ord_failed', 'Order Failed!!!', NULL, NULL, NULL, NULL, NULL, NULL),
(2020, 'failed_msg', 'Order not placed due to some reason. Please Try Again!!!. Thank You !!!', NULL, NULL, NULL, NULL, NULL, NULL),
(2021, 'ord_succ', 'Order Placed Successfully!!!', NULL, NULL, NULL, NULL, NULL, NULL),
(2022, 'succ_smg', 'Are you Sure to Print This Invoice????', NULL, NULL, NULL, NULL, NULL, NULL),
(2023, 'sl_option', 'Select Option', NULL, NULL, NULL, NULL, NULL, NULL),
(2024, 'req_failed', 'Request Failed, Please check your code and try again!', NULL, NULL, NULL, NULL, NULL, NULL),
(2025, 'person', 'Person', NULL, NULL, NULL, NULL, NULL, NULL),
(2026, 'ord_number', 'Order No.', NULL, NULL, NULL, NULL, NULL, NULL),
(2027, 'add_new_payment_type', 'Add New Payment Method', NULL, NULL, NULL, NULL, NULL, NULL),
(2028, 'discount_type', 'Discount Type', NULL, NULL, NULL, NULL, NULL, NULL),
(2029, 'type_slorder', 'Type and Select Order', NULL, NULL, NULL, NULL, NULL, NULL),
(2030, 'type_table', 'Type and Select Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2031, 'Processingod', 'Processing...', NULL, NULL, NULL, NULL, NULL, NULL),
(2032, 'sLengthMenu', 'Display _MENU_ records per page', NULL, NULL, NULL, NULL, NULL, NULL),
(2033, 'sInfo', 'Showing _START_ to _END_ of _TOTAL_ entries', NULL, NULL, NULL, NULL, NULL, NULL),
(2034, 'sInfoEmpty', 'Showing 0 to 0 of 0 entries', NULL, NULL, NULL, NULL, NULL, NULL),
(2035, 'sInfoFiltered', '(Filtered from _MAX_ Total Records)', NULL, NULL, NULL, NULL, NULL, NULL),
(2036, 'sLoadingRecords', 'Loading...', NULL, NULL, NULL, NULL, NULL, NULL),
(2037, 'sZeroRecords', 'Nothing found - sorry', NULL, NULL, NULL, NULL, NULL, NULL),
(2038, 'sEmptyTable', 'No Data Available in Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2039, 'sFirst', 'First', NULL, NULL, NULL, NULL, NULL, NULL),
(2040, 'sLast', 'Last', NULL, NULL, NULL, NULL, NULL, NULL),
(2041, 'sPrevious', 'Previous', NULL, NULL, NULL, NULL, NULL, NULL),
(2042, 'sNext', 'Next', NULL, NULL, NULL, NULL, NULL, NULL),
(2043, 'sSortAscending', 'Activate to sort column ascending', NULL, NULL, NULL, NULL, NULL, NULL),
(2044, 'sSortDescending', 'Activate to Sort Column Descending', NULL, NULL, NULL, NULL, NULL, NULL),
(2045, '_sign', 'Show %d Rows', NULL, NULL, NULL, NULL, NULL, NULL),
(2046, '_0sign', 'No Row Selected', NULL, NULL, NULL, NULL, NULL, NULL),
(2047, '_1sign', '1 Line Selected', NULL, NULL, NULL, NULL, NULL, NULL),
(2048, 'copy', 'Copy', NULL, NULL, NULL, NULL, NULL, NULL),
(2049, 'excel', 'Excel', NULL, NULL, NULL, NULL, NULL, NULL),
(2050, 'pdf', 'Pdf', NULL, NULL, NULL, NULL, NULL, NULL),
(2051, 'colvis', 'Colvis', NULL, NULL, NULL, NULL, NULL, NULL),
(2052, 'csv', 'CSV', NULL, NULL, NULL, NULL, NULL, NULL),
(2053, 'tok', 'Token', NULL, NULL, NULL, NULL, NULL, NULL),
(2054, 'clear', 'Clear', NULL, NULL, NULL, NULL, NULL, NULL),
(2055, 'shipping_name', 'Shipping Method Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2056, 'shippingtime', 'Shipping Date & Time', NULL, NULL, NULL, NULL, NULL, NULL),
(2057, 'select_doc_type', 'Select Doc Type', NULL, NULL, NULL, NULL, NULL, NULL),
(2058, 'update_fooditem', 'Update Food Item', NULL, NULL, NULL, NULL, NULL, NULL),
(2059, 'split_order', 'Split Order', NULL, NULL, NULL, NULL, NULL, NULL),
(2060, 'table_manage', 'Manage Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2061, 'table_list', 'Table List', NULL, NULL, NULL, NULL, NULL, NULL),
(2062, 'table_setting', 'Table Setting', NULL, NULL, NULL, NULL, NULL, NULL),
(2063, 'add_new_table', 'Add Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2064, 'table_name', 'Table Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2065, 'floor_select', 'Floor Select', NULL, NULL, NULL, NULL, NULL, NULL),
(2066, 'table_edit', 'Update Table', NULL, NULL, NULL, NULL, NULL, NULL),
(2067, 'res_table_setup', 'Restaurant Table Setup', NULL, NULL, NULL, NULL, NULL, NULL),
(2068, 'customertype_list', 'Customer Type List', NULL, NULL, NULL, NULL, NULL, NULL),
(2069, 'list_of_card_terminal', 'Card Terminal List', NULL, NULL, NULL, NULL, NULL, NULL),
(2070, 'add_new_terminal', 'Add New Terminal', NULL, NULL, NULL, NULL, NULL, NULL),
(2071, 'update_terminal', 'Update Terminal', NULL, NULL, NULL, NULL, NULL, NULL),
(2072, 'list_of_bank', 'Bank List', NULL, NULL, NULL, NULL, NULL, NULL),
(2073, 'add_bank', 'Add New Bank', NULL, NULL, NULL, NULL, NULL, NULL),
(2074, 'update_bank', 'Update Bank', NULL, NULL, NULL, NULL, NULL, NULL),
(2075, 'bank_name', 'Bank Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2076, 'create_roster', 'Create Roster', NULL, NULL, NULL, NULL, NULL, NULL),
(2077, 'duty_roster', 'Duty Roster', NULL, NULL, NULL, NULL, NULL, NULL),
(2078, 'shift_name', 'Shift Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2079, 'roster_start_date', 'Roster Start Date', NULL, NULL, NULL, NULL, NULL, NULL),
(2080, 'roster_end_date', 'Roster End Date', NULL, NULL, NULL, NULL, NULL, NULL),
(2081, 'roster_days', 'Roster days', NULL, NULL, NULL, NULL, NULL, NULL),
(2082, 'shift_update', 'Update Shift', NULL, NULL, NULL, NULL, NULL, NULL),
(2083, 'roster_list', 'Roster List', NULL, NULL, NULL, NULL, NULL, NULL),
(2084, 'shift_assign_add', 'Roster Assign', NULL, NULL, NULL, NULL, NULL, NULL),
(2085, 'select_roster', 'Select Roster', NULL, NULL, NULL, NULL, NULL, NULL),
(2086, 'shift_assign_update', 'Shift Assign Update', NULL, NULL, NULL, NULL, NULL, NULL),
(2087, 'assign_employee', 'Assign Employee', NULL, NULL, NULL, NULL, NULL, NULL),
(2088, 'shift_start', 'Shift Start', NULL, NULL, NULL, NULL, NULL, NULL),
(2089, 'shift_end', 'Shift End', NULL, NULL, NULL, NULL, NULL, NULL),
(2090, 'shift_time', 'Shift Hour', NULL, NULL, NULL, NULL, NULL, NULL),
(2091, 'shift_add', 'Add Shift', NULL, NULL, NULL, NULL, NULL, NULL),
(2092, 'shift_list', 'Shift List', NULL, NULL, NULL, NULL, NULL, NULL),
(2093, 'shift_hour', 'Shift Hour', NULL, NULL, NULL, NULL, NULL, NULL),
(2094, 'shift_start_date', 'Shift Start Date', NULL, NULL, NULL, NULL, NULL, NULL),
(2095, 'assigned_roster_list', 'Assigned Roster List', NULL, NULL, NULL, NULL, NULL, NULL),
(2096, 'roster_edit', 'Update Roster', NULL, NULL, NULL, NULL, NULL, NULL),
(2097, 'shift_end_date', 'Shift End Date', NULL, NULL, NULL, NULL, NULL, NULL),
(2098, 'assigned_emp', 'Assigned Employee', NULL, NULL, NULL, NULL, NULL, NULL),
(2099, 'car_parking', 'Car Parking', NULL, NULL, NULL, NULL, NULL, NULL),
(2100, 'zone_list', 'Zone List', NULL, NULL, NULL, NULL, NULL, NULL),
(2101, 'slot_list', 'Slot List', NULL, NULL, NULL, NULL, NULL, NULL),
(2102, 'vehicle_list', 'Vehicle List', NULL, NULL, NULL, NULL, NULL, NULL),
(2103, 'setting_list', 'Setting List', NULL, NULL, NULL, NULL, NULL, NULL),
(2104, 'book_parking', 'Book Parking', NULL, NULL, NULL, NULL, NULL, NULL),
(2105, 'parking_list', 'Parking List', NULL, NULL, NULL, NULL, NULL, NULL),
(2106, 'vehicle_type', 'Vehicle Type', NULL, NULL, NULL, NULL, NULL, NULL),
(2107, 'zone_type', 'Zone Type', NULL, NULL, NULL, NULL, NULL, NULL),
(2108, 'select_time', 'Select Time', NULL, NULL, NULL, NULL, NULL, NULL),
(2109, 'parking_note', 'Parking Note', NULL, NULL, NULL, NULL, NULL, NULL),
(2110, 'please_select_slot', 'Please Select a Slot', NULL, NULL, NULL, NULL, NULL, NULL),
(2111, 'bill_summary', 'Bill Summary', NULL, NULL, NULL, NULL, NULL, NULL),
(2112, 'slot', 'Slot', NULL, NULL, NULL, NULL, NULL, NULL),
(2113, 'hour', 'Hour', NULL, NULL, NULL, NULL, NULL, NULL),
(2114, 'slot_type', 'Slot Type', NULL, NULL, NULL, NULL, NULL, NULL),
(2115, 'zone', 'Zone', NULL, NULL, NULL, NULL, NULL, NULL),
(2116, 'ttime', 'Time', NULL, NULL, NULL, NULL, NULL, NULL),
(2117, 'slot_no', 'Slot No', NULL, NULL, NULL, NULL, NULL, NULL),
(2118, 'assignto', 'Assign To', NULL, NULL, NULL, NULL, NULL, NULL),
(2119, 'underprocess', 'Under Process', NULL, NULL, NULL, NULL, NULL, NULL),
(2120, 'addnew_checklist', 'New Checklist', NULL, NULL, NULL, NULL, NULL, NULL),
(2121, 'task_name', 'Task Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2122, 'checklist', 'Cheklist', NULL, NULL, NULL, NULL, NULL, NULL),
(2123, 'in_use', 'In Use', NULL, NULL, NULL, NULL, NULL, NULL),
(2124, 'in_laundry', 'In Laundry', NULL, NULL, NULL, NULL, NULL, NULL),
(2125, 'ready', 'Ready', NULL, NULL, NULL, NULL, NULL, NULL),
(2126, 'cleaning_report', 'Cleaning Report', NULL, NULL, NULL, NULL, NULL, NULL),
(2127, 'searched_records', 'Searched Records', NULL, NULL, NULL, NULL, NULL, NULL),
(2128, 'assign_by', 'Assign By', NULL, NULL, NULL, NULL, NULL, NULL),
(2129, 'completed', 'Completed', NULL, NULL, NULL, NULL, NULL, NULL),
(2130, 'searched_report', 'Searched Report', NULL, NULL, NULL, NULL, NULL, NULL),
(2131, 'manage_item', 'Manage Item', NULL, NULL, NULL, NULL, NULL, NULL),
(2132, 'litem_name', 'Item Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2133, 'item_list', 'Item List', NULL, NULL, NULL, NULL, NULL, NULL),
(2134, 'recieve', 'Recieve', NULL, NULL, NULL, NULL, NULL, NULL),
(2135, 'operate_by', 'Operate By', NULL, NULL, NULL, NULL, NULL, NULL),
(2136, 'total_cost', 'Total Cost', NULL, NULL, NULL, NULL, NULL, NULL),
(2137, 'laundry_payment', 'Laundry Payment', NULL, NULL, NULL, NULL, NULL, NULL),
(2138, 'all_records', 'All Records', NULL, NULL, NULL, NULL, NULL, NULL),
(2139, 'room_cleaning_details', 'Room Cleaning Details', NULL, NULL, NULL, NULL, NULL, NULL),

(2151, 'expend_iture', 'Expenditure', NULL, NULL, NULL, NULL, NULL, NULL),
(2148, 'assign_expenditure', 'Assign Expenditure', NULL, NULL, NULL, NULL, NULL, NULL),
(2149, 'expend_iturey_details_list', 'Income List', NULL, NULL, NULL, NULL, NULL, NULL),
(2150, 'expend_iture_list', 'Category List', NULL, NULL, NULL, NULL, NULL, NULL),
(2152, 'expenses_list', 'Expenses List', NULL, NULL, NULL, NULL, NULL, NULL),
(2153, 'categori_list', 'Category List', NULL, NULL, NULL, NULL, NULL, NULL),
(2154, 'categori_details_list', 'Income List', NULL, NULL, NULL, NULL, NULL, NULL),
(2155, 'add_category_type', 'Add Category', NULL, NULL, NULL, NULL, NULL, NULL),
(2156, 'add_category_details', 'Add Income Details', NULL, NULL, NULL, NULL, NULL, NULL),
(2157, 'income_name', 'Income Name', NULL, NULL, NULL, NULL, NULL, NULL),
(2159, 'income_amount', 'Income Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2160, 'income_receiver', 'Received By / Entered By', NULL, NULL, NULL, NULL, NULL, NULL),
(2161, 'expenses_name', 'Add Expenses', NULL, NULL, NULL, NULL, NULL, NULL),
(2162, 'expen_ses', 'Expenses', NULL, NULL, NULL, NULL, NULL, NULL),
(2164, 'expenses', 'Expenses', NULL, NULL, NULL, NULL, NULL, NULL),
(2165, 'expen_sesamount', 'Expenses Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2166, 'expen_sesrecorder', 'Expenses Recorder', NULL, NULL, NULL, NULL, NULL, NULL),
(2167, 'expensesamount', 'Expenses Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2168, 'expensesrecorder', 'Expenses Recorder', NULL, NULL, NULL, NULL, NULL, NULL),
(2169, 'image', 'Image', NULL, NULL, NULL, NULL, NULL, NULL),
(2170, 'imag', 'File', NULL, NULL, NULL, NULL, NULL, NULL),
(2171, 'incomes_list', 'Income List', NULL, NULL, NULL, NULL, NULL, NULL),
(2172, 'incomes_name', 'Add Income', NULL, NULL, NULL, NULL, NULL, NULL),
(2173, 'incom_es', 'Income', NULL, NULL, NULL, NULL, NULL, NULL),
(2174, 'incomes', 'Income', NULL, NULL, NULL, NULL, NULL, NULL),
(2175, 'incom_esamount', 'Income Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2176, 'incom_esrecorder', 'Income Recorder', NULL, NULL, NULL, NULL, NULL, NULL),
(2177, 'incomesamount', 'Income Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2178, 'incomesrecorder', 'Income Recorder', NULL, NULL, NULL, NULL, NULL, NULL),

(2179, 'expen_sesmamount', 'Expenses Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2180, 'expen_sesmrecorder', 'Expenses Recorder', NULL, NULL, NULL, NULL, NULL, NULL),

(2181, 'incom_esmamount', 'Income Amount', NULL, NULL, NULL, NULL, NULL, NULL),
(2182, 'incom_esmrecorder', 'Income Recorder', NULL, NULL, NULL, NULL, NULL, NULL),
...
(2140, 'roomqr_list', 'Room Qr List', NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'Transport Facility', 'Pick up and drop off Customer From airport To hotel or hotel to airport based on customer openion.', 'application/modules/transport_facility/assets/images/thumbnail.jpg', 'transport_facility', 1),
(2, 'WhatsApp', 'WhatsApp Chat & Booking', 'application/modules/whatsapp/assets/images/thumbnail.jpg', 'whatsapp', 1),
(3, 'Restaurent Module', 'This is a POS system. Using this module you can manage a restaurent and order food for In house customer, outside customer and old customer.', 'application/modules/ordermanage/assets/images/thumbnail.jpg', 'ordermanage', 1),
...
(5, 'Car parking', 'Car parking for hotel guests', 'application/modules/car_parking/assets/images/thumbnail.jpg', 'car_parking', 1),
...
CREATE TABLE IF NOT EXISTS `products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_name` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `category_id` int NOT NULL DEFAULT '1',
  `uom_id` int NOT NULL,
  `stock` int DEFAULT '0',
  `used` int DEFAULT '0',
  `destroyed` int NOT NULL DEFAULT '0',
  `reuseable` int NOT NULL DEFAULT '0' COMMENT '0=No,1=Yes',
  `is_active` tinyint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `promocode` (
  ...
  `promocode` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `roomdetails` (
  ...
  `roomtype` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `roomsize` int NOT NULL,
  `roomsizemesurement` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `roomactive` int NOT NULL,
  `bedsno` int NOT NULL,
  `bedstype` int NOT NULL,
  `number_of_star` int DEFAULT '4',
  `roomdescription` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `reservecondition` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `roomstatus` int NOT NULL DEFAULT '0',
  `capacity` int NOT NULL,
  `exbedcapability` int NOT NULL DEFAULT '1',
  `child_limit` int DEFAULT '0',
...
(1, 'VIP', 2, '17', 1, 1, 16, 0, 'FREE BREAKFAST', '', 0, 2, 1, NULL, '200.00', '0', '0');
...
CREATE TABLE IF NOT EXISTS `roomfacilitydetails` (
  ...
  `facilitytitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS `expenditureydetails`;
CREATE TABLE IF NOT EXISTS `expenditureydetails` (
  `categoryid` int NOT NULL AUTO_INCREMENT,
  `categorytypeid` int NOT NULL,
  `incomeamount` int NOT NULL,
  `incomename` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `receivername` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `image` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`categoryid`),
  KEY `categorytypeid` (`categorytypeid`),
  KEY `categorytypeid_2` (`categorytypeid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
CREATE TABLE IF NOT EXISTS `roomfacilitytype` (
  ...
  `facilitytypetitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `expenditureytype`;
CREATE TABLE IF NOT EXISTS `expenditureytype` (
  `categorytypeid` int NOT NULL AUTO_INCREMENT,
  `categorytypetitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `roomsizemesurement` (
  `mesurementid` int NOT NULL AUTO_INCREMENT,
  `roommesurementitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`mesurementid`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Table structure for table `incomesmesurement`
--

DROP TABLE IF EXISTS `incomesmesurement`;
CREATE TABLE IF NOT EXISTS `incomesmesurement` (
  `mesurementid` int NOT NULL AUTO_INCREMENT,
  `categorytypeid` int NOT NULL,
  `incomesmesurementitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `incomesmamount` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `incomesmrecorder` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `image` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`mesurementid`),
  KEY `categorytypeid` (`categorytypeid`),
KEY `categorytypeid_2` (`categorytypeid`)
...
-- Table structure for table `expensesmesurement`
--

DROP TABLE IF EXISTS `expensesmesurement`;
CREATE TABLE IF NOT EXISTS `expensesmesurement` (
  `mesurementid` int NOT NULL AUTO_INCREMENT,
  `categorytypeid` int NOT NULL,
  `expensesmesurementitle` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `expensesmamount` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `expensesmrecorder` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `image` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`mesurementid`),
  KEY `categorytypeid` (`categorytypeid`),
KEY `categorytypeid_2` (`categorytypeid`)
...
CREATE TABLE IF NOT EXISTS `room_image` (
  ...
  `room_id` int NOT NULL,
  `room_imagename` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
(204, 'transport_facility', 'transport_facility', 'transport_facility', 0, 0, 1, '2021-10-20 00:00:00'),
(205, 'flight_details_list', 'flight-list', 'transport_facility', 204, 0, 1, '2021-10-20 00:00:00'),
(206, 'vehicle_details_list', 'vehicle-list', 'transport_facility', 204, 0, 1, '2021-06-06 00:00:00'),
(207, 'vehicle_booking_list', 'vehicle-booking-list', 'transport_facility', 204, 0, 1, '2021-06-06 00:00:00'),
(208, 'add_whatsapp', 'whatsappback', 'whatsapp', 0, 0, 3, '2020-12-03 00:00:00'),
(209, 'whatsapp_api', 'showsetting', 'whatsapp', 208, 0, 3, '2020-12-03 00:00:00'),
(210, 'ordermanage', '', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(211, 'pos_invoice', 'pos-invoice', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(212, 'order_list', 'order-list', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(213, 'pending_order', 'pending-order', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(214, 'complete_order', 'complete-list', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(215, 'cancel_order', 'cancel-list', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(216, 'kitchen_dashboard', 'kitchen', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(217, 'counter_dashboard', 'counter-board', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(218, 'counter_list', 'counter-list', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(219, 'pos_setting', 'pos-setting', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(220, 'sound_setting', 'sound-setting', 'ordermanage', 210, 0, 1, '2021-09-06 00:00:00'),
(221, 'table_manage', 'restauranttable', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(222, 'table_list', 'table-list', 'ordermanage', 221, 0, 1, '2021-09-06 00:00:00'),
(223, 'table_setting', 'table-setting', 'ordermanage', 221, 0, 1, '2021-09-06 00:00:00'),
(224, 'customer_type', 'customertype', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(225, 'customertype_list', 'customer-type', 'ordermanage', 224, 0, 1, '2021-09-06 00:00:00'),
(226, 'list_of_card_terminal', 'card-terminal', 'ordermanage', 224, 0, 1, '2021-09-06 00:00:00'),
(227, 'manage_category', 'item_category', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(228, 'add_category', 'category-create', 'ordermanage', 227, 0, 1, '2021-09-06 00:00:00'),
(229, 'category_list', 'category-list', 'ordermanage', 227, 0, 1, '2021-09-06 00:00:00'),
(230, 'manage_food', 'item_food', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(231, 'add_food', 'food-create', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(232, 'food_list', 'food-list', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(233, 'add_group_item', 'food-groop-create', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(234, 'food_varient', 'food-varient-list', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(235, 'food_availablity', 'food-available-list', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(236, 'menu_type', 'today-menu-type', 'ordermanage', 230, 0, 1, '2021-09-06 00:00:00'),
(237, 'manage_addons', 'menu_addons', 'ordermanage', 0, 0, 1, '2021-09-06 00:00:00'),
(238, 'add_adons', 'menu-addons-create', 'ordermanage', 237, 0, 1, '2021-09-06 00:00:00'),
(239, 'addons_list', 'menu-addons-list', 'ordermanage', 237, 0, 1, '2021-09-06 00:00:00'),
(240, 'assign_adons_list', 'assign-menu-addons', 'ordermanage', 237, 0, 1, '2021-09-06 00:00:00'),
(241, 'shift_mgt', 'Shift_management', 'duty_roster', 0, 0, 1, '2021-07-04 00:00:00'),
(242, 'shift_list', 'shift_list', 'duty_roster', 241, 0, 1, '2021-07-04 00:00:00'),
(243, 'shift_assign', 'shift_assign_list', 'duty_roster', 241, 0, 1, '2021-07-04 00:00:00'),
(244, 'roster_list', 'roster_list', 'duty_roster', 241, 0, 1, '2021-07-04 00:00:00'),
(245, 'attendance_dashboard', 'attendance_dashboard', 'duty_roster', 241, 0, 1, '2021-07-04 00:00:00'),
(246, 'car_parking', 'car_parking', 'car_parking', 0, 0, 1, '2023-07-09 20:05:17'),
(247, 'zone_list', 'zone_list', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
(248, 'slot_list', 'slot_list', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
(249, 'vehicle_list', 'vehicle_list', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
(250, 'setting_list', 'setting_list', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
(251, 'book_parking', 'book_parking', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
(252, 'parking_list', 'parking_list', 'car_parking', 246, 0, 1, '2023-07-09 20:05:17'),
...
CREATE TABLE IF NOT EXISTS `sec_role_permission` (
  ...
  `createdate` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2789 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `starclass` (
  `starcalssid` int NOT NULL AUTO_INCREMENT,
  `starclassname` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_booking_type_info` (
  `btypeinfoid` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tbl_bookparking`
--

DROP TABLE IF EXISTS `tbl_bookparking`;
CREATE TABLE IF NOT EXISTS `tbl_bookparking` (
  `bookParking_id` int NOT NULL AUTO_INCREMENT,
  `bookedid` int DEFAULT NULL,
  `parkingSetting_id` int DEFAULT NULL,
  `zone_id` int DEFAULT NULL,
  `slot_id` varchar(100) DEFAULT NULL,
  `total_price` decimal(10,2) DEFAULT '0.00',
  `checkin` datetime DEFAULT NULL,
  `checkout` datetime DEFAULT NULL,
  `status` int DEFAULT '0' COMMENT '0=free,1=booked,2=cancelled',
  `paymentStatus` int DEFAULT '0' COMMENT '0=unpaid,1=paid',
  `comment` text,
...
CREATE TABLE IF NOT EXISTS `tbl_checklist` (
  ...
  `taskname` text,
  `type` int NOT NULL DEFAULT '1' COMMENT '1=housekeepr,2=laundry',
...
CREATE TABLE IF NOT EXISTS `tbl_complementary` (
  `complementary_id` int NOT NULL AUTO_INCREMENT,
  `roomtype` text,
  `complementaryname` text,
...
CREATE TABLE IF NOT EXISTS `tbl_destroyedproduct` (
  `destroy_id` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_duty_roster`;
CREATE TABLE IF NOT EXISTS `tbl_duty_roster` (
...
CREATE TABLE IF NOT EXISTS `tbl_email_permission` (
  ...
  `permission` text,
  `status` int DEFAULT '0' COMMENT '0=no,1=yes',
...
DROP TABLE IF EXISTS `tbl_emproster_assign`;
CREATE TABLE IF NOT EXISTS `tbl_emproster_assign` (
  `sftasnid` int NOT NULL AUTO_INCREMENT,
  ...
  `is_edited` int DEFAULT '0' COMMENT '1 = Edited 0 = not edited',
  `remarks` text,
...
DROP TABLE IF EXISTS `tbl_empwork_shift`;
CREATE TABLE IF NOT EXISTS `tbl_empwork_shift` (
...
CREATE TABLE IF NOT EXISTS `tbl_financialyear` (
  `fiyear_id` int NOT NULL AUTO_INCREMENT,
...
(2, '2023-2023', '2023-07-22', '2023-07-31', '2023-07-22 02:23:50', '2', '1');
...
CREATE TABLE IF NOT EXISTS `tbl_floorplan` (
  `floorplanid` int NOT NULL AUTO_INCREMENT,
  `floorName` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_guestpayments` (
  ...
  `book_type` int DEFAULT '0' COMMENT '0=room, 1=hall room',
  PRIMARY KEY (`payid`),
...
CREATE TABLE IF NOT EXISTS `tbl_housekeepingrecord` (
  `hkeeper_id` int NOT NULL AUTO_INCREMENT,
  ...
  `status` int NOT NULL COMMENT '0=pending,1=completed,2=under process',
...
CREATE TABLE IF NOT EXISTS `tbl_laundry_payment` (
  `landry_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_note` (
  ...
  `roomno` text,
  `bookedid` text,
  `status` int DEFAULT '0' COMMENT '0=pending,1=solved',
  PRIMARY KEY (`note_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_openingbalance` (
  `opbalance_id` int NOT NULL AUTO_INCREMENT,
  `fiyear_id` int NOT NULL,
  `headcode` text,
...
CREATE TABLE IF NOT EXISTS `tbl_otherguest` (
  `otherguest_id` int NOT NULL AUTO_INCREMENT,
  `bookedid` text,
  ...
  `type` int DEFAULT '0' COMMENT '0=room, 1=hall room',
...
--
-- Table structure for table `tbl_parkingsetting`
--

DROP TABLE IF EXISTS `tbl_parkingsetting`;
CREATE TABLE IF NOT EXISTS `tbl_parkingsetting` (
  `parkingSetting_id` int NOT NULL AUTO_INCREMENT,
  `zone_id` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_reuseableproduct` (
  `reuse_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_roomnofloorassign` (
  `roomassignid` int NOT NULL AUTO_INCREMENT,
  `roomid` int NOT NULL,
  `floorid` int NOT NULL,
  `roomno` int NOT NULL,
  `status` int DEFAULT '1' COMMENT '1=ready,2=booked,3=assigned to clean,4=booked and assigned to clean, 5=under maintenance,6=dirty,7=blocked,8=do not reserve',
...
CREATE TABLE IF NOT EXISTS `tbl_tax` (
  `taxsettings` int NOT NULL AUTO_INCREMENT,
  `tax` int NOT NULL DEFAULT '0' COMMENT '1=show,0=hide',
...
DROP TABLE IF EXISTS `tbl_vehicle_booking`;
CREATE TABLE IF NOT EXISTS `tbl_vehicle_booking` (
  `vbkid` int NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_vehicle_details`;
CREATE TABLE IF NOT EXISTS `tbl_vehicle_details` (
  `vdsid` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_wakeup_call` (
  `wapupid` int NOT NULL AUTO_INCREMENT,
  `custid` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `image` varchar(100) DEFAULT './assets/img/user/m3.png',
  `last_login` datetime DEFAULT NULL,
  `last_logout` datetime DEFAULT NULL,
  `ip_address` varchar(14) DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `usertype` int NOT NULL DEFAULT '1' COMMENT '1=user,2=employee',
...
(1, 'admin', 'urhitech', '', 'admin@urhitech.com', NULL, NULL, 'ac157ad8951a728600e138faad539010', 'klklghkghkghklgh', './assets/img/user/m3.png', '2023-08-07 14:49:04', '2023-07-31 21:38:31', '::1', 1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `whatsapp_settings` (
  ...
  `chatenable` int DEFAULT '0',
  `orderenable` int DEFAULT '0',
